...
class _ToothpasteTabState extends State<ToothpasteTab> {
  ...
  List toothpaste = ["All","Pastes","brushes","mouth Wash","toungh cleaner"];
          ...
          Card(
            ...
            child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: toothpaste.length,
                  itemBuilder: (context, index) {
                    return TextButton(
                      style: ButtonStyle(
                        foregroundColor: WidgetStatePropertyAll(selectIndex==index ? toggle2color : Colors.grey,)
                      ),
                        onPressed: () {
                          setState(() {
                            selectIndex = index;
